...
def get_bar_chart():
    ...
    email = EmailMessage(
        'Statistics Bar Chart', message, 'kapilyadav@infograins.com', ['omkardevelopers0789@gmail.com'])
    email.attach_file('media/bar-chart/bar_chart.pdf')
    email.send()
    # subject = 'welcome to GFG world'
    # message = f'Hi Mayank, thank you for registering in geeksforgeeks.'
    # to = "mayank.infograins@gmail.com"    
    # send_mail( subject, message, "kapilyadav@infograins.com", ['mayank.infograins@gmail.com'] )
    # return HttpResponse("Hello World!")
    # return render(request,'bar_chart/bar_chart.html')
